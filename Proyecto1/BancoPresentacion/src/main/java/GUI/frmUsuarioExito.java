...
public class frmUsuarioExito extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(botonRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 580, 420, 100));

        labelFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Crear Usuario - Exito.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmUsuarioExito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmUsuarioExito().setVisible(true);
            }
        });
    }
